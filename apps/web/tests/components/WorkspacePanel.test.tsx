...
import { WorkspacePanel } from '../../src/components/WorkspacePanel.js';
import { isSafeWorkspaceSegment } from '../../src/components/workspace-validation.js';
import type { PublicProfile } from '../../src/api/types.js';
